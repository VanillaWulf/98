...
screen game_hud():
    ...
    frame:
        ...
        vbox:
            ...
            text renpy.substitute(_("День") + " [current_day]") size 28
            text "💰 [money]$" size 28
            text renpy.substitute(_("Действия:") + " [actions]") size 28
            text renpy.substitute(_("Провода:") + " [wires]") size 28
            text renpy.substitute(_("Микросхемы:") + " [chips]") size 28
            
            null height 10
            
            text _("Активные заказы:") size 24 bold True
