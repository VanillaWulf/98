...
label day4_hangout_mikko:
    if clients["mikko"]["hangouts_day_3"]:
        if clients["andrea"]["nonni_delivered"]:
            ...
            "Микко увел Квсита на самый север в самый стермный квартал, куда так просто никто не ходил."
            ...
            scene bg micko4_3 
            "Квист бережливо сжимал конверт, пока они шли с Микко обратно через Старый Центр."
