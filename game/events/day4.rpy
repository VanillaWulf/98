label day4_start:
    ...
    if clients["mikko"]["hangouts_day_3"]:
        "После вчерашней встречи с Микко ты абсолютно не выспался... Но ты помог другу."
        $ actions = 1
    ...
    "День тянулся тревожной пустотой."
    # ==========================
    # ВЕЧЕР
    # ==========================
...
label day4_evening:
    ...
    k "Работаю. А как там твои поиски уязвимостей в системе ОКБР?"

    i "Ха-ха! Вчера их хакнул! Если ты сделаешь браслет, я для тебя все что угодно сделаю, клянусь!"
