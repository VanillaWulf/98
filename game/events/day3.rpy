...
label day3_linh_visit:
    ...
    if clients["mikko"]["hangouts_day_2"]:
        "Квист потирает набитые шишки."
    else:
        k "Как обычно."

    l "Кстати, читал про ограбление Лувра в 2025?"
    k "Я не очень интересуюсь таким"
    if clients["mikko"]["hangouts_day_2"]:            
    ...
    if clients["bekker"]["order_completed"] and clients["bekker"]["order_active"]:
        ...
        menu:
            ...
            "Готов, отдам бесплатно":
                ...
                b "Ты меня спас, папаша. Сделаю тебе скидочку на следующий заказ 2 кредита на деталь, правда, всегда поставщики могут офигеть, но все равно лучше, чем ничего"
                $ clients["bekker"]["base_price"] -= 2
            "Готов, с тебя 15":
                play sound "order.mp3" noloop
