...
translate english strings:
    ...
    new "Advance through dialogue, activate the interface."
    ...
    new "Advance through dialogue without making choices."
    ...
    new "Roll forward the previous action."

    # game/screens.rpy:1046
    old "Скрывает интерфейс пользователя."
    new "Hide the user interface."
    ...
    new "Enable the supported {a=https://www.renpy.org/l/voicing}text-to-speech{/a}."
